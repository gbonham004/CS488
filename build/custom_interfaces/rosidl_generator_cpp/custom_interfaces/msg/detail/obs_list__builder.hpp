...
class Init_ObsList_d_list
{
public:
  explicit Init_ObsList_d_list(::custom_interfaces::msg::ObsList & msg)
  : msg_(msg)
  {}
  ::custom_interfaces::msg::ObsList d_list(::custom_interfaces::msg::ObsList::_d_list_type arg)
  {
    msg_.d_list = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_ObsList_d_list y_list(::custom_interfaces::msg::ObsList::_y_list_type arg)
  {
    msg_.y_list = std::move(arg);
    return Init_ObsList_d_list(msg_);
  }
